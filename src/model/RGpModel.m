classdef RGpModel < Model % Regression GP model from Matlab 2015b+
  ...
  methods (Access = public)
    function obj = RGpModel(modelOptions, xMean)
      % constructor
...
function [nlZ, dnlZ] = linear_gp(linear_hyp, s_hyp, inf, mean, cov, lik, x, y)
  ...
  [nlZ, s_dnlZ] = gp(hyp, inf, mean, cov, lik, x, y); % TODO: Here use the fitgrp method
  dnlZ = unwrap(s_dnlZ)';
end
