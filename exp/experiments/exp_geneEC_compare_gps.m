exp_id = 'exp_geneEC_compare_gps';
exp_description = 'Surrogate CMA-ES model, GP and RGP + rebase, generation EC, 2 functions, 15 instances';
...
if (strfind(mfilename('fullpath'), 'afs'))
  ...
  matlabcommand = 'matlab_mff_2015b';
end
...
bbParamDef(1).values = {2};      % {2, 5, 10, 20};
bbParamDef(2).name   = 'functions';
bbParamDef(2).values = num2cell(15:16);  % {1, 2, 3, 5, 6, 8, 10, 11, 12, 13, 14, 20, 21};
